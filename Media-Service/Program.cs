...
using Media_Service.src._04_Api.Extensions;
using Media_Service.src._04_Api.Middlewares;
...
builder.Services.AddMediaServices(builder.Configuration.GetConnectionString("DefaultConnection"));
