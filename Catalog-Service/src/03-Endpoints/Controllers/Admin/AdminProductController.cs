...
namespace Catalog_Service.src._03_Endpoints.Controllers.Admin
{
    ...
    public class AdminProductController : ControllerBase
    {
        ...
        [HttpPatch("{id}/slug")]
        public async Task<IActionResult> UpdateSlug(int id, [FromBody] UpdateSlugRequest request)
        {
            // Assuming there is a validator for UpdateSlugRequest if needed
