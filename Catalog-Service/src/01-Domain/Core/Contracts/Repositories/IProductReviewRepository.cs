...
namespace Catalog_Service.src._01_Domain.Core.Contracts.Repositories
{
    public interface IProductReviewRepository
    {
        ...
        Task<ProductReview> AddReviewAsync(ProductReview review, CancellationToken cancellationToken = default);
        Task RemoveByProductIdAsync(int productId, CancellationToken cancellationToken = default);
