...
namespace Catalog_Service.src._01_Domain.Core.Contracts.Services
{
    ...
    {
        Task<Product> GetByIdAsync(int id, string? vendorUserId = null, CancellationToken cancellationToken = default);
        ...
        Task SetApprovalStatusAsync(int id, bool isApproved, CancellationToken cancellationToken = default);
    }
}